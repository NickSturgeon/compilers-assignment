...
void gen_incode();
Token_Node* gen_init(Token_Node*);
Token_Node* gen_input(Token_Node*);
Token_Node* gen_assignment_string(Token_Node*);
Token_Node* gen_comparison_string(Token_Node*);
Token_Node* gen_output(Token_Node*);
