...
Token aa_func02(char lexeme[]) {
    ...
    /* check if it is a floating point or integer VID */
    /* integer begins with i, d, n, or m */
    if (t.attribute.vid_lex[0] == 'i'
        || t.attribute.vid_lex[0] == 'd'
        || t.attribute.vid_lex[0] == 'n'
        || t.attribute.vid_lex[0] == 'm') {
        t.avid_attribute.flags = 'd'; /* integer */
    } else {
        t.avid_attribute.flags = 'f'; /* floating */
    }
